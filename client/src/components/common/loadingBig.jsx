...
export const LoadingBig = () => {
  return (
    <div className='flex space-x-2 justify-center items-center w=[200px] m-auto mt-[300px] ' >
      <div className='h-8 w-8 bg-red-400 rounded-full animate-bounce [animate-dealy:-0.3s]'></div>
      <div className='h-8 w-8 bg-red-400 rounded-full animate-bounce [animate-dealy:-0.15s]'></div>
