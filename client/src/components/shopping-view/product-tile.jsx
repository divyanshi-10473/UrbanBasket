  ...
  <div onClick={() => handleGetProductDetails(product?._id)} className="flex-grow">
    ...
    <CardContent className="p-4">
      ...
      <div className="flex justify-between items-center mb-2">
        <span className="text-[16px] text-muted-foreground">{categoryMap[product?.category]}</span>
        <span className="text-[16px] text-muted-foreground">{brandMap[product?.brand]}</span>
      </div>
  ...
  <CardFooter>
    {
      !homepage ?
        ...
        :
        <Button className="w-full" onClick={() => navigate('/shop/listing')}>Shop More</Button>
    }
  </CardFooter>
</Card>
